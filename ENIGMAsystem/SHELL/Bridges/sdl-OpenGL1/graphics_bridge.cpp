...
#include <Platforms/sdl/SDLmain.h>
...
namespace enigma {
  ...
  namespace swaphandling {
    ...
    static void investigate_swapcontrol_support() {
      ...
      //TODO: SDL_x11 seems to have some support for this, but then we lose the benefit of using SDL in a cross-platform way.
      ext_swapcontrol_supported = true;
      mesa_swapcontrol_supported = false;
...
#include <Platforms/sdl/SDLwindow.h> // window_set_caption
...
void set_synchronization(bool enable) {
	...
	//if (enigma::sdl::main_display) {
	  GLXDrawable drawable = glXGetCurrentDrawable();

     //TODO: check for failure. Also, is this even right?
